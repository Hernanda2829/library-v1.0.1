import '../daftar_pinjaman_screen/widgets/listrevolusimanajemen_item_widget.dart';
...
class DaftarPinjamanScreen extends GetWidget<DaftarPinjamanController> {
  @override
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      decoration: AppDecoration.txtOutlineGray500,
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
              ...
              Padding(
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller.daftarPinjamanModelObj.value
                        .listrevolusimanajemenItemList.length,
                    itemBuilder: (context, index) {
                      ListrevolusimanajemenItemModel model = controller
                          .daftarPinjamanModelObj
                          .value
                          .listrevolusimanajemenItemList[index];
                      return ListrevolusimanajemenItemWidget(
                        model,
                      );
                    },
                  ),
              ...
              Align(
                ...
                child: Container(
                  ...
                  margin: getMargin(top: 280, bottom: 0),
